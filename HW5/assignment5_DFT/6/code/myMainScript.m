...
title('N-point DFT of K1 shown using imshow'); truesize(figure(1),[400 400]); colormap('jet'); colorbar;
...
title('N-point DFT of K2 shown using imshow'); colormap('jet'); colorbar;
