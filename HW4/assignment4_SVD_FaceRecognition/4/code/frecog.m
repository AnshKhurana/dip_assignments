function [ total_test_images,correctly_detected_test_images ] = frecog(k,dataset,h,w,num_train_speakers,num_train_files,evec_func,include_top_ecoffs)
%FRECOG Summary of this function goes here
...
%             x_ecoff_diff = bsxfun(@minus,eigen_coefficients_cumulative,x_ecoff);
            ...
            x_distance = sum(x_ecoff_diff.^2,1);
